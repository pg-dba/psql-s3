...
echo -e "${RED}full backup restoring...${NC}"
...
echo "restore_command = 'barman-cloud-wal-restore -P minio --endpoint-url http://u20d1h4:9000 s3://backups private-postgres-1 %f %p'" > /var/lib/postgresql/data/recovery.conf
